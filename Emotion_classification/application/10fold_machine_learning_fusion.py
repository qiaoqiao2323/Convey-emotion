...
def main(argv):
    ...
    for fold_index in range(10):
        ...
        train_audio = generator.transform(generator.Emotion_training_a, generator.mean_audio, generator.std_audio)
        train_tactile = generator.transform(generator.Emotion_training_t, generator.mean_tactile, generator.std_tactile)
        ...
        y_train = generator.Emotion_training_label
    ...
    y_train_total = generator.Emotion_training_label
